...
func TestGetProcessCount(t *testing.T) {
	...
	count = GetProcessCount(processes2, 1)
...
func TestFormatCompactOutput(t *testing.T) {
	...
	output = FormatCompactOutput("/usr/bin/bash", 2)
